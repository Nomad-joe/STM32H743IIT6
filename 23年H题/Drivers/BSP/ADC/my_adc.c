...
{   
    ...
    hadc1.Init.ConversionDataManagement = ADC_CONVERSIONDATA_DMA_CIRCULAR;  // ? 关键：使用DMA
...
void MX_ADC3_Init(void)
{
    ...
    /* 
     * 3. 注意：PLL2时钟已在MX_ADC1_Init中配置完成
     *    但需要确认VCO范围与ADC1一致（MEDIUM）
     *    如果之前ADC3用的是WIDE，这里需要统一
     */
